...
class Email extends Config {
    public function sendPasswordReset($email, $token) {
        ...
        try {
            ...
            $mail->Body    = 'To complete the password reset process, please go to the following link: <a href="' . $this->systemURL . 'password/new?token=' . $token . '">' . $this->systemURL . 'password/new?token=' . $token . '</a>.';
            $mail->AltBody = 'To complete the password reset process, please go to the following link: ' . $this->systemURL . 'password/new?token=' . $token . '.';
            $mail->send();
